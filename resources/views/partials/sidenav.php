        ...
        <div class="overflow-auto h-100" id="sidenav-scrollbar">
            <ul class="navbar-nav">
                ...
                <?php if ($userId < 100): ?>
                    ...
                    <!-- SQL Runner (developer tool) -->
                    <li class="nav-item">
                        <a class="nav-link <?php echo $currentPath == '/tools/sql-runner' ? 'active' : ''; ?>" href="<?php echo url('tools/sql-runner'); ?>">
                            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="ni ni-curved-next text-danger text-sm opacity-10"></i>
                            </div>
                            <span class="nav-link-text ms-1">SQL Runner</span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <!-- Shortlets -->
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#shortletMenu" aria-expanded="false">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-building text-primary text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Shortlets</span>
                    </a>
                    <div class="collapse" id="shortletMenu">
                        <ul class="nav ms-4">
                            <li class="nav-item"><a class="nav-link" href="<?php echo url('shortlet/dashboard'); ?>">Dashboard</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo url('shortlet/awaiting-listing'); ?>">Awaiting Listing</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo url('shortlet/listed'); ?>">Listed</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo url('shortlet/in-progress'); ?>">In Progress</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo url('shortlet/closed'); ?>">History</a></li>
                        </ul>
                    </div>
                </li>
