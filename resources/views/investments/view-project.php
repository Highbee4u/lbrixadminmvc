                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-end">
                                <a href="<?php echo isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'], '/investments/') !== false ? htmlspecialchars($_SERVER['HTTP_REFERER'], ENT_QUOTES) : '/investments/new-projects'; ?>" class="btn btn-sm btn-secondary">
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <div class="btn-group" role="group">
                                                                            ...
                                                                            <ul class="dropdown-menu" aria-labelledby="actionDropdown<?php echo $task['inspectiontaskid']; ?>">
                                                                                <li>
                                                                                    <a class="dropdown-item <?php echo (($task['statusid'] > 1 && $task['statusid'] != 4) ? 'disabled' : ''); ?>" 
                                                                                       href="/investments/view-project?id=<?php echo htmlspecialchars($project['itemid'] ?? '', ENT_QUOTES); ?>&inspectionid=<?php echo htmlspecialchars($task['inspectiontaskid'] ?? '', ENT_QUOTES); ?>&approvestatus=4">
                                                                                        Approve
                                                                                    </a>
                                                                                </li>
                                                                                <li>
                                                                                    <a class="dropdown-item <?php echo (($task['statusid'] > 1 && $task['statusid'] != 5) ? 'disabled' : ''); ?>" 
                                                                                       href="/investments/view-project?id=<?php echo htmlspecialchars($project['itemid'] ?? '', ENT_QUOTES); ?>&inspectionid=<?php echo htmlspecialchars($task['inspectiontaskid'] ?? '', ENT_QUOTES); ?>&approvestatus=5">
                                                                                        Reject
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
