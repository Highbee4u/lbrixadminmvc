...
<div class="container-fluid py-4">
            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title mb-3">
                        <i class="fas fa-filter me-2"></i>Filter Inspection Rejected Project
                    </h6>
            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <h6>Inspection Rejected Project</h6>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0 table-hover">
                            ...
                            <tbody>
                                <?php if (!empty($inpectionRejectedList['data'])): ?>
                                    <?php foreach ($inpectionRejectedList['data'] as $project): ?>
                                        <tr>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="10" class="text-center py-4">
                                            <p class="text-sm text-secondary mb-0">No Inspection Rejected Project found</p>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
    ...
    <?php $paginationData = $inpectionRejectedList; include __DIR__ . '/../partials/pagination.php'; ?>
...
(function(){
    ...
    if (applyBtn) {
        applyBtn.addEventListener('click', function(){
            ...
            window.location.href = (() => {
                const baseUrl = '<?php echo url("investments/inspection-rejected"); ?>';
    ...
    if (resetBtn) {
        resetBtn.addEventListener('click', function(){
            window.location.href = '<?php echo url("investments/inspection-rejected"); ?>';
        });
    }
})();
...
document.addEventListener('click', function(e){
    const approveBtn = e.target.closest('.approve-project');
    if (approveBtn) {
        const id = approveBtn.getAttribute('data-itemid');
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                .then(({ok, data}) => {
                    if (ok && data.success) {
                        toastr.success('Project approved successfully');
                        setTimeout(() => window.location.reload(), 1500);
                    } else {
                        toastr.error(data.message || 'Failed to approve project');
                    }
                }).catch(() => toastr.error('Error occurred while approving project'));
            }
        });
    }
});
