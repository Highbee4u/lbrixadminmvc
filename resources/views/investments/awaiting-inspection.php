...
<div class="container-fluid py-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0 table-hover">
                            ...
                            <tbody>
                                <?php if (!empty($awaitingInvestmentList['data'])): ?>
                                    <?php foreach ($awaitingInvestmentList['data'] as $project): ?>
                                        <tr>
                                             <td class="align-middle text-center">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="actionDropdown<?php echo htmlspecialchars($project['itemid'] ?? '', ENT_QUOTES); ?>">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item recreate-inspection" href="javascript:;" 
                                                               ...
                                                               data-title="<?php echo htmlspecialchars($project['title'] ?? '', ENT_QUOTES); ?>">
                                                                <i class="fas fa-redo me-2"></i>Re-create Inspection Task
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
    ...
    <?php $paginationData = $awaitingInvestmentList; include __DIR__ . '/../partials/pagination.php'; ?>
...
// Re-create Inspection Task handler
document.addEventListener('click', function(e){
    const recreate = e.target.closest('.recreate-inspection');
    if (recreate) {
        e.preventDefault();
        const itemid = recreate.getAttribute('data-itemid');
        const title = recreate.getAttribute('data-title') || 'this project';
        ...
        Swal.fire({
            title: 'Re-create Inspection?',
            text: `Are you sure you want to re-create inspection task for "${title}"?`,
            icon: 'question',
