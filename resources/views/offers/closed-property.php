<?php $pageTitle = 'Closed Property Offers'; ?>
            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title mb-3">
                        <i class="fas fa-filter me-2"></i>Filter Closed Property Offers
                    </h6>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0 table-hover">
                            ...
                            <tbody>
                                <?php if (!empty($closedProperties)): ?>
                    <?php foreach ($closedProperties as $bid): ?>
                                    <tr>
                    ...
                    <?php else: ?>
                                    <tr>
                                        <td colspan="17" class="text-center py-4">
                                            <p class="text-sm text-secondary mb-0">No Closed Property Offers found</p>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
