            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title mb-3">
                        <i class="fas fa-filter me-2"></i>Filter Active Property Offers
                    </h6>
                        ...
                        <table class="table align-items-center mb-0 table-hover">
                            ...
                            <tbody>
                                <?php if (!empty($activeProperties)): ?>
                                    <?php foreach ($activeProperties as $bid): ?>
                                        <tr>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="17" class="text-center py-4">
                                            <p class="text-sm text-secondary mb-0">No Active Property Offers found</p>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
